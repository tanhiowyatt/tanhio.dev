...
(function () {
  ...
  const GA_MEASUREMENT_ID = 'G-VD84JGXH0P'; // Insert your GA Measurement ID here (e.g. G-XXXXXXXXXX)
    ...
    const consentHTML = `
      <div id="cookie-consent-banner" class="fixed bottom-6 left-1/2 -translate-x-1/2 w-[calc(100%-3rem)] md:w-full md:max-w-xl z-50 p-6 md:p-8 rounded-3xl bg-[#0B0B0F]/70 border border-white/10 backdrop-blur-xl shadow-2xl flex flex-col gap-5 transition-all duration-500 transform translate-y-12 opacity-0 select-none">
        ...
        <div class="flex items-center gap-3 mt-1 w-full">
          <button id="cookie-accept-btn" class="flex-1 px-3 py-2.5 text-[11px] sm:text-xs font-bold rounded-full bg-[#4b68ff] text-white hover:bg-[#3b58ef] transition-all duration-300 cursor-pointer shadow-lg shadow-[#4b68ff]/20 border-0 text-center justify-center flex items-center">
            Accept all
          </button>
